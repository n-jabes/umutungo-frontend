...
type SettingsTab = "agents" | "audit" | "users";
  ...
  if (user?.role === "agent") {
    return (
      <Card className="p-8 shadow-sm">
        <h1 className="text-2xl font-semibold tracking-tight text-foreground">Settings restricted</h1>
        <p className="mt-2 text-sm text-muted">Agent accounts cannot manage users, agents, or the audit trail.</p>
      </Card>
    );
  }
